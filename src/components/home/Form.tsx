      ...
      >
        ...
        <form onSubmit={handleSubmit} className="hidden lg:block">
          <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-10 px-8 py-8">
            ...
            <div style={{ boxShadow: "rgba(0, 0, 0, 0.15) 4px 4px 2.6px" }}>
              <select
                name="state"
                value={formValues.state}
                onChange={handleInputChange}
                className="py-3 pl-4 w-full border-none rounded-lg text-xl bg-white"
            ...
            <div>
              <div className="flex items-center gap-4">
                <input
                  ...
                  className="w-5 h-5"
                />
                <div>Accept terms & conditions etc.</div>
              </div>
              {errors.termsAccepted && (
                <p className="text-color3 text-sm">{errors.termsAccepted}</p>
              )}
            </div>
          </div>
          ...
          <div className="flex w-full items-center justify-center">
            <button
              type="submit"
              className="px-10 bg-color1 text-color3 font-semibold py-3 rounded-lg text-xl"
            >
              Generate OTP
            </button>
          </div>
        ...
        <form
          ...
          className="grid grid-cols-1 gap-10 px-4 py-10 lg:hidden"
        >
          <div>
            <input
              type="text"
          ...
          <div>
            <div className="flex items-center gap-4">
              <input
                ...
                className="w-5 h-5"
              />
              <div className="text-[12px]">Accept terms & conditions etc</div>
            </div>
            {errors.termsAccepted && (
          ...
          <div className="flex w-full items-center justify-center">
            <button
              type="submit"
              className="px-10 bg-color1 font-semibold py-3 rounded-lg text-xl"
            >
              Generate OTP
            </button>
          </div>
